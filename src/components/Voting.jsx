    ...
    const handleClick = (type, randomCat) => {
        ...
        if (type === "like") {
            ...
            if (favourites.indexOf(randomCat) === -1) {
                ...
                setLog(prevLog => [...prevLog, { id: randomCat.id, content: "was added to Favourites", type: "fav", time: time }])
            } else {
                setActive(false)
                favourites.pop()
    ...
    return (
        <Layout flexCol>
            ...
            <Wrapper>
                ...
                <Flexbox>
                    <Actions>
                        <ActionBtn like onClick={() => handleClick("like", randomCat)}>
                        ...
                        <ActionBtn fav onClick={() => handleClick("fav", randomCat)}>
                        ...
                        <ActionBtn disl onClick={() => handleClick("dis",randomCat)}>
