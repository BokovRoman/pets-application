...
const UserAction = ({id, content, type, time }) => {
    ...
    return (
        <Wrapper>
            <div>
                <Time>{time}</Time>
                <p>Image ID: <span>{id}</span> {content}</p>
            </div>
            <SVG viewBox={viewBox}> 
                {path}
            </SVG>
